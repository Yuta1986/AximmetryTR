...
**Tracked Camera Workflow / トラッキングカメラワークフロー** から、Aximmetry側の INPUTS / delay / sync / keying / output を順番に復習します。
...
4. **Tracked Camera Workflow**: 本資料の主題となる順番で I/O から出力まで追う
...
# 4. Tracked Camera Workflow / トラッキングカメラワークフロー
