...
> 学習・復習の順路としても、用語や参照先を確認するための一覧としても使えます。
> トレーニングを受けた方の復習用としてはもちろん、一部の講義だけ受けた方や、導入説明後に抜けた内容を補いながら確認したい方にも役立つようにまとめています。
...
Tracking Calibration と Nodal Offset は、単なる数値調整ではなく、**現実とヴァーチャルを同期させるための工程** だと理解することです。
...
- トラッキングオフセットは、トラッキングセンサーとカメラ側の位置関係を扱う補正です
...
本流のトラッキング付きグリーンバックワークフローを理解した上で、**AX Scene EditorやUnreal側へ少しだけ手を伸ばす** ための入口を持つことです。
...
ただし、「Aximmetryはライブ合成だけで終わらない」ことを実感するには有効です。
...
- Aximmetryの映像を UnrealやAX Scene側で受ける考え方がある
...
> **注意**  
> Virtual Screen や Blueprint を使った発展項目の細かな操作はバージョンに影響されやすいため、本文では概念と役割に集中し、手順は公式Learnを参照してください。
